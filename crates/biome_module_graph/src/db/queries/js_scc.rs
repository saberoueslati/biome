use crate::{JsImportPath, ModuleDb, ModuleInfoKind};
...
///
/// The result is cached by Salsa and recomputed when the module graph changes.
#[salsa::tracked(no_eq, returns(ref))]
pub fn js_module_sccs(db: &dyn ModuleDb) -> JsModuleSccs {
